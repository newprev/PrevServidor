    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataUltAlt', models.DateTimeField(default=datetime.datetime(2021, 6, 5, 17, 43, 20, 662497))),
                ('dataCadastro', models.DateTimeField(default=datetime.datetime(2021, 6, 5, 17, 43, 20, 662508))),
            ],
        ),
        migrations.CreateModel(
            name='TetosPrev',
            fields=[
                ...
                ('dataUltAlt', models.DateTimeField(default=datetime.datetime(2021, 6, 5, 17, 43, 20, 662846))),
                ('dataCadastro', models.DateTimeField(default=datetime.datetime(2021, 6, 5, 17, 43, 20, 662857))),
            ],
        ),
    ]
